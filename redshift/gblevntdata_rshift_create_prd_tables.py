...
from gblevntdata_rshift_sql_create_stmnt import create_table_queries, drop_table_queries, create_prd_schema_query
...
def create_schema(cur, conn):
    ...
    for query in create_prd_schema_query:
        cur.execute(query)
        conn.commit()
